          ...
          <div class="row row-cols-lg-5 row-cols-2">
            ...
            <div class="footer-column footer-menu mb-4 mb-lg-0">
              ...
              <ul class="sub-menu__list list-unstyled">
                <li class="sub-menu__item"><a href="https://wet-love.com/About" class="menu-link1 menu-link_us-s">About Us</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/FAQ" class="menu-link1 menu-link_us-s">FAQ</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/FAQ" class="menu-link1 menu-link_us-s">DELIVERY</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/FAQ" class="menu-link1 menu-link_us-s">PAYENT</a></li>
              </ul>
            </div>
            ...
            <div class="footer-column footer-menu mb-4 mb-lg-0">
              ...
              <ul class="sub-menu__list list-unstyled">
                <li class="sub-menu__item"><a href="https://wet-love.com/store/New_Sale" class="menu-link1 menu-link1 menu-link_us-s">New Sale</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/store/Male_Toys" class="menu-link1 menu-link1 menu-link_us-s">Male_Toys</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/store/Vibrators" class="menu-link1 menu-link1 menu-link_us-s">Vibrators</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/store/Bondage" class=" menu-link1 menu-link1 menu-link_us-s">Bondage</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/store/Any_Toys" class= "menu-link1 menu-link1 menu-link_us-s">Any_Toys</a></li>
            ...
            <div class="footer-column footer-menu mb-4 mb-lg-0">
              ...
              <ul class="sub-menu__list list-unstyled">
                <li class="sub-menu__item"><a href="https://wet-love.com/cart" class="menu-link1 menu-link_us-s">Basket</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/order" class="menu-link1 menu-link_us-s">Orders</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/account" class="menu-lin1k menu-link_us-s">Wishlist</a></li>
         
                <li class="sub-menu__item"><a href="https://wet-love.com/FAQ" class="menu-link1 menu-link_us-s">Shipping & Payment</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/FAQ" class="menu-link1 menu-link_us-s">Privacy Policy</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/FAQ" class="menu-link1 menu-link_us-s">Return Policy</a></li>
                <li class="sub-menu__item"><a href="https://wet-love.com/FAQ" class="menu-link1 menu-link_us-s">Edit Terms & Conditions</a></li>
