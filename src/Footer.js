    ...
    return (
        ...
        <div class="footer-middle container">
          <div class="row row-cols-lg-5 row-cols-2">
            ...
            <div style={{color:'#141F46'}} class='stroke-text2 h1 smooth-16 smooth-161 text-uppercase fw-bold mb-3 mb-xl-4 mb-xl-5'>Wet Love</div>
          </a>
              </div>
            ...
            <div class="footer-column footer-menu mb-4 mb-lg-0">
              ...
              <ul class="sub-menu__list list-unstyled">
                <li class="sub-menu__item"><a href="http://localhost:3000/About" class="menu-link1 menu-link_us-s">About Us</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/FAQ" class="menu-link1 menu-link_us-s">FAQ</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/FAQ" class="menu-link1 menu-link_us-s">DELIVERY</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/FAQ" class="menu-link1 menu-link_us-s">PAYENT</a></li>
              </ul>
            </div>
            ...
            <div class="footer-column footer-menu mb-4 mb-lg-0">
              ...
              <ul class="sub-menu__list list-unstyled">
                <li class="sub-menu__item"><a href="http://localhost:3000/store/New_Sale" class="menu-link1 menu-link1 menu-link_us-s">New Sale</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/store/Male_Toys" class="menu-link1 menu-link1 menu-link_us-s">Male_Toys</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/store/Vibrators" class="menu-link1 menu-link1 menu-link_us-s">Vibrators</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/store/Bondage" class=" menu-link1 menu-link1 menu-link_us-s">Bondage</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/store/Any_Toys" class= "menu-link1 menu-link1 menu-link_us-s">Any_Toys</a></li>
            ...
            <div class="footer-column footer-menu mb-4 mb-lg-0">
              ...
              <ul class="sub-menu__list list-unstyled">
                <li class="sub-menu__item"><a href="http://localhost:3000/cart" class="menu-link1 menu-link_us-s">Basket</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/order" class="menu-link1 menu-link_us-s">Orders</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/account" class="menu-lin1k menu-link_us-s">Wishlist</a></li>
         
                <li class="sub-menu__item"><a href="http://localhost:3000/FAQ" class="menu-link1 menu-link_us-s">Shipping & Payment</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/FAQ" class="menu-link1 menu-link_us-s">Privacy Policy</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/FAQ" class="menu-link1 menu-link_us-s">Return Policy</a></li>
                <li class="sub-menu__item"><a href="http://localhost:3000/FAQ" class="menu-link1 menu-link_us-s">Edit Terms & Conditions</a></li>
            ...
            <div class="modal-header">
              <ul class="nav nav-pills" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                  <a class="nav-link active rounded-1 text-uppercase" id="pills-item-1-tab" data-bs-toggle="pill" href="index.html#pills-item-1" role="tab" aria-controls="pills-item-1" aria-selected="true">WOMEN</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link rounded-1 text-uppercase" id="pills-item-2-tab" data-bs-toggle="pill" href="index.html#pills-item-2" role="tab" aria-controls="pills-item-2" aria-selected="false">MEN</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link rounded-1 text-uppercase" id="pills-item-3-tab" data-bs-toggle="pill" href="index.html#pills-item-3" role="tab" aria-controls="pills-item-3" aria-selected="false">KIDS</a>
                </li>
              </ul>
                ...
                <div class="tab-pane fade show active" id="pills-item-1" role="tabpanel" aria-labelledby="pills-item-1-tab">
                  <div class="row">
                    <ul class="nav nav-tabs list-unstyled col-5 d-block" id="myTab" role="tablist">
                      ...
                      <li class="nav-item position-relative" role="presentation">
                        <a class="nav-link nav-link_rline" id="tab-item-3-tab" data-bs-toggle="tab" href="index.html#tab-item-3" role="tab" aria-controls="tab-item-3" aria-selected="false"><span class="rline-content">KIDS</span></a>
                      </li>
                      <li class="nav-item position-relative" role="presentation">
                        <a class="nav-link nav-link_rline" href="index.html#"><span class="rline-content">HOME</span></a>
                      </li>
                      <li class="nav-item position-relative" role="presentation">
                        <a class="nav-link nav-link_rline" href="index.html#"><span class="rline-content">COLLECTION</span></a>
                      </li>
                      <li class="nav-item position-relative" role="presentation">
                        <a class="nav-link nav-link_rline text-red" href="index.html#">SALE UP TO 50% OFF</a>
                      </li>
                      <li class="nav-item position-relative" role="presentation">
                        <a class="nav-link nav-link_rline" href="index.html#"><span class="rline-content">NEW</span></a>
                      </li>
                      <li class="nav-item position-relative" role="presentation">
                        <a class="nav-link nav-link_rline" href="index.html#"><span class="rline-content">SHOES</span></a>
                      </li>
                      <li class="nav-item position-relative" role="presentation">
                        <a class="nav-link nav-link_rline" href="index.html#"><span class="rline-content">ACCESSORIES</span></a>
                      </li>
                      <li class="nav-item position-relative" role="presentation">
                        <a class="nav-link nav-link_rline" href="index.html#"><span class="rline-content">JOIN LIFE</span></a>
                      </li>
                      <li class="nav-item position-relative" role="presentation">
                        <a class="nav-link nav-link_rline" href="index.html#"><span class="rline-content">#UOMOSTYLE</span></a>
                      </li>
                    </ul>
                    ...
                    <div class="tab-content col-7" id="myTabContent">
                      <div class="tab-pane fade show active" id="tab-item-1" role="tabpanel" aria-labelledby="tab-item-1-tab">
                        <ul class="sub-menu list-unstyled">
                          ...
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Best Sellers</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Collaborations®</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Sets</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Denim</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Jackets & Coats</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Overshirts</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Trousers</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Jeans</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Dresses</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Sweatshirts and Hoodies</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">T-shirts & Tops</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Shirts & Blouses</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Shorts and Bermudas</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Shoes</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="shop3.html" class="menu-link menu-link_us-s">Accessories</a>
                          </li>
                          <li class="sub-menu__item">
                            <a href="index.html#" class="menu-link menu-link_us-s">Bags</a>
                          </li>
                          <li class="sub-menu__item">
        ...
        <div class="product-single">
          ...
          <div class="product-single__detail">
            ...
            <form name="addtocart-form" method="post">
              <div class="product-single__swatches">
                <div class="product-swatch text-swatches">
                  ...
                  <a href="index.html#" class="sizeguide-link" data-bs-toggle="modal" data-bs-target="#sizeGuide">Size Guide</a>
                </div>
                <div class="product-swatch color-swatches">
                  ...
                  <div class="swatch-list">
                    ...
                    <label class="swatch swatch-color js-swatch" for="swatch-13" aria-label="Grey" data-bs-toggle="tooltip" data-bs-placement="top" titlSe="Grey" style={{color: "#E4E4E4"}}></label>
                  </div>
                </div>
              </div>
            ...
            <div class="product-single__addtolinks">
              <a href="index.html#" class="menu-link menu-link_us-s add-to-wishlist"><svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><use     /></svg><span>Add to Wishlist</span></a>
